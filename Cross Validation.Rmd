...
for(i in 1:(n-k))
{
  ...
  mape_1[i,1:length(test)] <- (mean(abs(fcast_1[['mean']] - test)) / test) * 100
#  mae_1[i,1:length(test)] <- abs(fcast_1[['mean']]-test) #MAE
  ...
  mape_2[i,1:length(test)] <- (mean(abs(fcast_2[['mean']] - test)) / test) * 100
#  mae_2[i,1:length(test)] <- abs(fcast_2[['mean']]-test) #MAE
  ...
  mape_3[i,1:length(test)] <- (mean(abs(fcast_3[['mean']] - test)) / test) * 100
#  mae_3[i,1:length(test)] <- abs(fcast_3[['mean']]-test)
  ...
  mape_4[i,1:length(test)] <- (mean(abs(fcast_4[['mean']] - test)) / test) * 100
...
#   mape_5[i,1:length(test)] <- (mean(abs(fcast_5[['mean']] - test)) / test) * 100
...
#   mape_6[i,1:length(test)] <- (mean(abs(fcast_6[['mean']] - test)) / test) * 100
...
```{r}
plot(1:48, colMeans(mape_1, na.rm=TRUE), type="l", 
     main = "MAPE vs forecast horizon plots", xlab='Forecast Horizon Plots', ylab='MAPE')
lines(1:48, colMeans(mape_2,na.rm=TRUE), type="l",col=2)
legend("topleft",legend=c("ETS: 0 - EXPANDING", "ETS: 0 - SLIDING"), col=1:6, lty=1, cex=0.7)
```

```{r}
plot(1:48, colMeans(mape_3, na.rm=TRUE), type="l", main = "MAPE vs forecast horizon plots", xlab='Forecast Horizon Plots', ylab='MAPE')
lines(1:48, colMeans(mape_4,na.rm=TRUE), type="l",col=2)
legend("topleft",legend=c("ARIMA(0,1,1)(1,1,2)[12] LAMBDA AUTO - EXPANDING",
                          "ARIMA(0,1,1)(1,1,2)[12] LAMBDA AUTO - SLIDING"),
       col=1:6, lty=1, cex=0.7)
```

```{r}
# plot(1:48, colMeans(mape_5, na.rm=TRUE), type="l", main = "MAPE vs forecast horizon plots", xlab='Forecast Horizon Plots', ylab='MAPE')
# lines(1:48, colMeans(mape_6,na.rm=TRUE), type="l",col=2)
# legend("topleft",legend=c("ARIMA(2,1,2)(1,1,2)[12] LAMBDA 0 - EXPANDING",
...
lines(1:48, colMeans(mape_2,na.rm=TRUE), type="l",col=2)
lines(1:48, colMeans(mape_3,na.rm=TRUE), type="l",col=3)
lines(1:48, colMeans(mape_4,na.rm=TRUE), type="l",col=4)
# lines(1:48, colMeans(mape_5,na.rm=TRUE), type="l",col=5)
# lines(1:48, colMeans(mape_6,na.rm=TRUE), type="l",col=6)
...
```{r}
# plot(1:48, colMeans(rmse_5,na.rm=TRUE), type="l", 
#      main = "RMSE vs forecast horizon plots", xlab='Forecast Horizon Plots', ylab='RMSE')
# lines(1:48, colMeans(rmse_6,na.rm=TRUE), type="l",col=2)
# legend("topleft",legend=c("ARIMA(2,1,2)(1,1,2)[12] LAMBDA 0 - EXPANDING",
#                           "ARIMA(2,1,2)(1,1,2)[12] LAMBDA 0 - SLIDING"),
#        col=1:6, lty=1, cex=0.7)
```
